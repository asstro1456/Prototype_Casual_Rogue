...
- `rune-trace/` — 현재 개발 중인 룬 경로 퍼즐 `v1.0.1`
...
게임의 핵심 규칙, 시스템 구조, 밸런스, UI 요구사항, 예외 처리,
QA 기준 및 최종 구현 방향은 저장소 소유자가 기획하고 결정했습니다.

HTML, CSS, JavaScript 구현 과정에는 생성형 AI 도구를 활용했습니다.
생성된 코드는 저장소 소유자의 지시에 따라 검수·수정·통합했습니다.
